...
class IndeterminateProgress extends Component {
    ...
    render() {
        ...
        return (<View // the background layer
         ref="bg" style={[IndeterminateProgress.defaultProps.style, style, this.props.style]} onLayout={this._onLayout}>
...
IndeterminateProgress.propTypes = Object.assign({}, (ViewPropTypes || View.propTypes), { 
