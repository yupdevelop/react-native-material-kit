...
class Slider extends Component {
    ...
    constructor(props) {
        ...
        this._defaultStepIncrement = () => this._toPixelScale(this.props.max) /
    ...
    render() {
        ...
        <Thumb ref="thumb" radius={this.props.thumbRadius} trackSize={this.props.trackSize} trackMarginH={this._trackMarginH} enabledColor={lowerTrackColor} disabledColor={upperTrackColor} touchPadding={this.props.thumbPadding} style={{
...
Slider.propTypes = Object.assign({}, (ViewPropTypes || View.propTypes), { 
