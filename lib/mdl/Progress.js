...
class Progress extends Component {
    ...
    render() {
        ...
        return (<View // the background layer
         ref="bg" style={[Progress.defaultProps.style, style, this.props.style]} onLayout={this._onLayout}>
        <Animated.View // the buffering layer
         ref="bufferLayer" style={{
            position: 'absolute',
...
Progress.propTypes = Object.assign({}, (ViewPropTypes || View.propTypes), { 
